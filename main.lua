...
local Window = Library:CreateWindow("Fate", Vector2.new(492, 598), Enum.KeyCode.RightShift)
...
local antibag = togglessector:AddToggle('Anti Bag', false, function(State)
    FateSettings.Blatant.Character.AntiBag = State
end)
...
local aura = togglessector:AddToggle("Auto Pick Cash", false, function(State)
    FateSettings.Blatant.Cash.AutoPickCash = State
end)
...
local discord = CreditsSection:AddButton("Our Developing Team", function(bool)
    setclipboard("Tezq_1|liamisgolden|https://discord.gg/pt4p6pGhe7 ")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
...
local esko = CreditsSection:AddButton("Owned by Fate", function(bool)
    setclipboard("https://www.youtube.com/@Tezq_1")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
...
local discord1 = CreditsSection:AddButton("Tezq", function(bool)
    setclipboard("Tezq_1")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
...
local discord2 = CreditsSection:AddButton("Liam", function(bool)
    setclipboard("liamisgolden")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
        Text = "Staff member copied on clipboard!";
        Icon = "rbxassetid://8768441000";
...
local discord3 = CreditsSection:AddButton("Copy website link.", function(bool)
    setclipboard("http://FateScripts.cc")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
...
local partners1 = partnersSection:AddButton("discord.gg/pt4p6pGhe7", function(bool)
    setclipboard("discord.gg/pt4p6pGhe7")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
...
local partners2 = partnersSection:AddButton("For Sale", function(bool)
    setclipboard("For Sale")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
        Text = "Supporter Copied on clipboard!";
        Icon = "rbxassetid://8768441000";
...
local partners = partnersSection:AddButton("For Sale", function(bool)
    setclipboard("For Sale")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
        Text = "Supporter Copied on clipboard!";
...
local partners4 = partnersSection:AddButton("For Sale", function(bool)
    setclipboard("For Sale")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
        Text = "Supporter Copied on clipboard!";
...
local partners6 = partnersSection:AddButton("For Sale", function(bool)
    setclipboard("For Sale")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
        Text = "Supporter Copied on clipboard!";
...
local partners5 = partnersSection:AddButton("Tezq_1", function(bool)
    setclipboard("https://tezq.sellsn.io")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Fate";
        Text = "Supporter Copied on clipboard!";
        Icon = "rbxassetid://8768441000";
...
RunSer.Heartbeat:Connect(function()
    if Alive(LocalPlayer) then
        if FateSettings.Blatant.Movement.SpeedEnabled and FateSettings.Blatant.Movement.SpeedType == "CFrame" then
            if FateSettings.Blatant.Movement.SpeedRenderType == "Default" then
                if LocalPlayer.Character.Humanoid.MoveDirection.Magnitude > 0 then
                    for i = 1, FateSettings.Blatant.Movement.SpeedAmount do
        ...
        if FateSettings.Blatant.Movement.SpeedEnabled and FateSettings.Blatant.Movement.SpeedType == "CFrame" then
            if FateSettings.Blatant.Movement.SpeedRenderType == "Fast" and Alive(LocalPlayer) then
                if LocalPlayer.Character.Humanoid.MoveDirection.Magnitude > 0 then
                    for i = 1, FateSettings.Blatant.Movement.SpeedAmount do
                        LocalPlayer.Character:TranslateBy(LocalPlayer.Character.Humanoid.MoveDirection)
                    end
        ...
        if FateSettings.Blatant.Cash.AutoPickCash then
            pcall(function()
        ...
        if FateSettings.Blatant.Character.AntiBag then
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Fate";
    Text = "https://discord.gg/pt4p6pGhe7";
    Icon = "http://www.roblox.com/asset/?id=8768441000";
    Duration = "3";
    callbakc = bindableFunction;
    Button1 = "Okay!";
...
print("__________________________FATE.CC__________________________")
print("| [Fate.cc] Executed version: 1.0")
print("| [Fate.cc] Your user is: "..game.Players.LocalPlayer.Name.. "") 
print("| [Fate.cc] Your id is: "..game.Players.LocalPlayer.UserId.. "")
print("| [Fate.cc] Job id: " ..game.JobId.. "")
print("| [Fate.cc] Join us discord.gg/pt4p6pGhe7                 ")
print("| [Fate.cc] Made by Tezq_1                 ")
print("| [Fate.cc] Website - https://Fate.cc         ")
